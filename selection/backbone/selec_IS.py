...
__all__=["build_att_backbone","PatchEmbed","BasicLayer","SwinTransformerBlock","WindowAttention","Mlp","window_reverse","window_partition","PatchMerging","swin"]
...
class swin(Backbone):
	...
	"""
	def __init__(self,pretrain_img_size=224,patch_en=True,  patch_size=4, in_chans=3, num_classes=1000,embed_dim=96, depths=[2, 2, 6, 2], num_heads=[3, 6, 12, 24],window_size=7, mlp_ratio=4., qkv_bias=True, qk_scale=None,drop_rate=0., attn_drop_rate=0., drop_path_rate=0.2,norm_layer=nn.LayerNorm, ape=False, patch_norm=True,out_indices=(0,1,2,3), frozen_stages=-1,use_checkpoint=False,):
		super().__init__()
...
def build_att_backbone(cfg,input_shape=None):
	model = swin(pretrain_img_size=cfg.MODEL.BACKBONE.PRETRAIN_IMAGE_SIZE,
